...
unlocked to sign the Applecoin-Qt.app bundle.
...
allowing somebody to distribute a Applecoin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the applecoin-qt.exe file inside the installer had not been tampered with.
