...
Applecoin is an experimental new digital currency that enables instant payments to
...
Applecoin is released under the terms of the MIT license. See `COPYING` for more
information or see http://opensource.org/licenses/MIT.

Applecoin is based on Bitcoin.
